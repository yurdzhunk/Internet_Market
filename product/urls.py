...
urlpatterns = [
    ...
    url(r'^shop/notebook/(?P<page_number>\d+)/$', 'product.views.notebook'),
    url(r'^shop/smartphone/(?P<page_number>\d+)/$', 'product.views.smartphone'),
    url(r'^shop/tv/(?P<page_number>\d+)/$', 'product.views.tv'),
